/*
 * Get the Top N articles based on Total Page Views
 */
...
public class TopNPageViews {

    public static class TopNPageViewsMap extends Mapper<LongWritable, Text, Text, LongWritable> {
     ...
     */
    public static class TopNPageViewsReduce extends Reducer<Text, LongWritable, Text, LongWritable> {
    ...
    public static class TopNPageViewsCombiner extends Reducer<Text, LongWritable, Text, LongWritable> {
   ...
   */
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setMapperClass(TopNPageViewsMap.class);
        job.setCombinerClass(TopNPageViewsCombiner.class);
        job.setReducerClass(TopNPageViewsReduce.class);
        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(LongWritable.class);
       
        FileInputFormat.addInputPath(job, new Path("wikicounts"));
        FileOutputFormat.setOutputPath(job, new Path("TopNPageViews"));
